...
class HumanAgeComparatorTest {
    ...
    void ensureThatAgeComparatorCorrects(){
        humans.sort(new HumanAgeComparator());
        assertEquals(human3, humans.get(0));
        assertEquals(human1, humans.get(1));
        assertEquals(human2, humans.get(2));
        assertEquals(human4, humans.get(3));
        assertEquals(human5, humans.get(4));
    }
}