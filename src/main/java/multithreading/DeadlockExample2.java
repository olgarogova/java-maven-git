...
public class DeadlockExample2 implements Runnable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DeadlockExample2.class);

    public DeadlockExample2(Lock lock1, Lock lock2) {
        this.lock1 = lock1;
        this.lock2 = lock2;
    }
    ...
    public void run() {
        ...
        logger.info(Thread.currentThread().getName() + " Attempting to lock lock2");
        lock2.lock();
