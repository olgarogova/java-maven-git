...
public class DeadlockFixed1 implements Runnable {
    private final Lock lock1;
    private final Lock lock2;

    private static final Logger logger = LoggerFactory.getLogger(DeadlockFixed1.class);

    public DeadlockFixed1(Lock lock1, Lock lock2) {
        this.lock1 = lock1;
        this.lock2 = lock2;
    }
